...
CREATE TABLE [ROOM] (
	...
	[ChatsListID] BIGINT NOT NULL,
	[DateCreated] DATETIME2 NOT NULL DEFAULT GETDATE(),
	PRIMARY KEY (UserName, ChatsListID)
);
GO
CREATE TABLE [MESSAGE] (
	[ID] BIGINT PRIMARY KEY IDENTITY(1,1),
	[Content] VARCHAR(8000) NOT NULL,
	[StatusMessage] BIT NOT NULL,
	[UserNameRoom] CHAR(25) NOT NULL,
	[ChatsListIDRoom] BIGINT NOT NULL,
	[DateCreated] DATETIME2 NOT NULL DEFAULT GETDATE()
);
GO
...
GO
ALTER TABLE [ROOM] ADD CONSTRAINT FK_ChatListID FOREIGN KEY([ChatsListID]) REFERENCES [CHATSLIST]([ID]) ON UPDATE NO ACTION ON DELETE NO ACTION;
GO
...
GO
ALTER TABLE [MESSAGE] ADD CONSTRAINT FK_MessageRoom FOREIGN KEY([UserNameRoom], [ChatsListIDRoom]) REFERENCES [ROOM]([UserName],[ChatsListID]) ON UPDATE NO ACTION ON DELETE NO ACTION;
GO
